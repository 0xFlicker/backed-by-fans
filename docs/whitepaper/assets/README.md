...
- `membership-timeline.svg`: Figure 1, separate access, NFT, and reward-eligibility states. The example assumes positive payments, enabled rewards, no refund, and no grant time. Event spacing is not a duration scale.
