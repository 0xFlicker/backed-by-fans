...
2. Reproduce through a second RPC and compare against the signed manifest.
...
complete a new review and deployment manifest, and explicitly supersede the old
...
user impact, containment actions, code and manifest digests, owner decisions,
