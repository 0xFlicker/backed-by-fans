...
| --- | --- | --- |
| Canonical public testnet USDG | BLOCKED | Approved official source publishes proxy address and token behavior is verified. |
...
`0x5fc5360D0400a0Fd4f2af552ADD042D716F1d168`. No approved official testnet USDG
address is currently published. Revalidate all values from the linked official
sources in [deployment.md](deployment.md) on execution day. A local mock is test
evidence only and must never appear in a public deployment manifest.
