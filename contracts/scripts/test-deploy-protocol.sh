...
assert_contains "$mock_log" "forge script script/DeployDirectProtocol.s.sol:DeployProtocol"
...
assert_contains "$mock_log" "cast chain-id --rpc-url"
assert_contains "$mock_log" "forge script script/DeployDirectProtocol.s.sol:ValidateProtocol --rpc-url"
assert_not_contains "$mock_log" "cast wallet address"
assert_not_contains "$mock_log" "--account"
...
mkdir -p "$test_dir/project/broadcast/DeployDirectProtocol.s.sol/46630"
printf '{}\n' >"$test_dir/project/broadcast/DeployDirectProtocol.s.sol/46630/run-latest.json"
: >"$mock_log"
"$deploy_wrapper" testnet resume-verify
assert_contains "$mock_log" "forge script script/DeployDirectProtocol.s.sol:ValidateCompletedProtocol --rpc-url"
assert_contains "$mock_log" "forge script script/DeployDirectProtocol.s.sol:DeployProtocol --rpc-url"
